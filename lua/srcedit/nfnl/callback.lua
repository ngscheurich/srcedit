...
local nvim = autoload("srcedit.nfnl.nvim")
local compile = autoload("srcedit.nfnl.compile")
local config = autoload("srcedit.nfnl.config")
local api = autoload("srcedit.nfnl.api")
